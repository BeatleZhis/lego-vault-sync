module BeatleZhis/lego-vault-sync
...
require (
	...
	github.com/aws/aws-sdk-go-v2/service/lightsail v1.50.0 // indirect
	...
	github.com/tencentcloud/tencentcloud-sdk-go/tencentcloud/common v1.1.41 // indirect
